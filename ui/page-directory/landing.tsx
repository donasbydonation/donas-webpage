    ...
    return (
        <div>
            ...
            <div style={{display:"flex"}}>
                ...
                <img src= {imagePath + "/01.jpg"} alt="" style={imageWidth} />
                <div style={imageMargin}></div>           
            </div>
            ...
            <div style={{display:"flex", background: "linear-gradient(#F8F8F8 40%, white)"}}>
                <div style={imageMargin}></div>
                <img src= {imagePath + "/02.jpg"} alt="" style={imageWidth}/>
                <div style={imageMargin}></div>           
            </div>
            ...
            <div style={{display:"flex"}}>
                <div style={imageMargin}></div>
                <img src= {imagePath + "/03.jpg"} alt="" style={imageWidth}/>
                <div style={imageMargin}></div>           
            </div>
            
            <div style={{display:"flex", backgroundColor:"#F8F8F8"}}>
                <div style={imageMargin}></div>
                <img src= {imagePath + "/04.jpg"} alt="" style={imageWidth}/>
                <div style={imageMargin}></div>           
            </div>
            
            <div style={{display:"flex"}}>
                <div style={imageMargin}></div>
                <img src= {imagePath + "/05.jpg"} alt="" style={imageWidth}/>
                <div style={imageMargin}></div>           
            </div>

            <div style={{display:"flex", backgroundColor:"#FF3363"}}>
                <div style={imageMargin}></div>
                <img src= {imagePath + "/06.jpg"} alt="" style={imageWidth}/>
                <div style={imageMargin}></div>           
            </div>

            <div style={{display:"flex"}}>
                <div style={imageMargin}></div>
                <img src= {imagePath + "/07.jpg"} alt="" style={imageWidth}/>
                <div style={imageMargin}></div>           
            </div>
